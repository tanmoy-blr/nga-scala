...
Built using vanilla-scala and sbt, we can execute the program as follows -

- Run `sbt assembly` on the project root folder
- cd `target/scala-2.13/`
- Execute `java -jar NGAScala-assembly-0.1.0-SNAPSHOT.jar "/tmp/nga/data`
